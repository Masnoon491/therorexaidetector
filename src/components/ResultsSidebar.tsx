...
const resultSlots: ResultItem[] = [
  { icon: Bot, label: "AI Score", sublabel: "Probability of AI generation" },
  { icon: User, label: "Human Score", sublabel: "Probability of human authorship" },
  { icon: BookOpen, label: "Readability Grade", sublabel: "Flesch-Kincaid level" },
];
    ...
    <aside className="w-80 lg:w-96 bg-navy text-navy-foreground flex flex-col">
      ...
      <div className="px-6 py-4 border-t border-navy-light">
        <p className="text-xs text-navy-foreground/40 text-center">
          Scan content to see detailed results
        </p>
      </div>
    </aside>
  );
